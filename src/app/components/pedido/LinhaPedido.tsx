...
export default function LinhaPedido(props: LinhaPedidoProps) {
    ...
    return (
        <div className="flex flex-row border border-txquar cursor-pointer rounded-md" onClick={() => props.onClick?.(props.pedido)}>
            {(user == "administração") && (
                <>
                    <CelulaPedido texto={props.pedido.nome_cliente} class={`w-[30%] text-start px-2 border-r rounded-l-md ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
                    <CelulaPedido texto={props.pedido.cod_pedido} class={`w-[10%] border-r ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
                    <CelulaPedido texto={props.pedido.quantidade} class={`w-[10%] border-r ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
            ...
            {(user == "loja") && (
                <>
                    <CelulaPedido texto={props.pedido.nome_cliente} class={`w-[45%] text-start px-2 border-r rounded-l-md ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
                    <CelulaPedido texto={props.pedido.cod_pedido} class={`w-[20%] border-r ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
                    <CelulaPedido texto={props.pedido.quantidade} class={`w-[20%] border-r ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
            ...
            {(user == "prensa") && (
                <>
                    <CelulaPedido texto={props.pedido.nome_cliente} class={`w-[45%] text-start px-2 border-r rounded-l-md ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
                    <CelulaPedido texto={props.pedido.cod_pedido} class={`w-[15%] border-r ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
                    <CelulaPedido texto={props.pedido.quantidade} class={`w-[15%] border-r ${props.pedido.prioridade == "1" ? "bg-prioralta" : props.pedido.prioridade == "2" ? "bg-priormedia" : ""}`} />
                    <CelulaPedido texto={props.pedido.impressao ? "✔" : ""} class={`${props.pedido.impressao ? "bg-verdepry text-verdesec" : "bg-vermelhopry"} w-[8%] border-r`} />
