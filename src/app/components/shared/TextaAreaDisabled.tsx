...
export default function TextAreaDisabled(props: TextAreaDisabledProps) {
    return (
        <div className="flex flex-col gap-1 mb-2">
            ...
            <textarea {...props} disabled cols={30} rows={5} className={`bg-pry border border-txter text-txsec p-1 rounded-md outline-none text-sm md:text-md font-semibold uppercase`} />
        </div>
    )
}